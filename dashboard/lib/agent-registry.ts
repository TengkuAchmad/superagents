...
export const AGENT_REGISTRY: AgentMeta[] = [
  ...
  // ── New 10 specialists (full software engineering team) ───────────────────
  {
    canonical_id: 'ui-designer',
    opencode_key: 'ui-designer',
    label: 'UI Designer',
    role: 'UX & Visual Design',
    icon: '🎨',
    color: '#ec4899',
    variants: ['ui-designer', 'designer', 'ux-designer'],
  },
  {
    canonical_id: 'frontend-engineer',
    opencode_key: 'frontend-engineer',
    label: 'Frontend Engineer',
    role: 'UI Implementation',
    icon: '🌐',
    color: '#3b82f6',
    variants: ['frontend-engineer', 'frontend', 'fe-engineer'],
  },
  {
    canonical_id: 'backend-engineer',
    opencode_key: 'backend-engineer',
    label: 'Backend Engineer',
    role: 'API & Schema',
    icon: '🗄️',
    color: '#14b8a6',
    variants: ['backend-engineer', 'backend', 'be-engineer'],
  },
  {
    canonical_id: 'integration-engineer',
    opencode_key: 'integration-engineer',
    label: 'Integration Engineer',
    role: 'Wiring & E2E Flows',
    icon: '🔌',
    color: '#f97316',
    variants: ['integration-engineer', 'integration', 'glue-engineer'],
  },
  {
    canonical_id: 'security-engineer',
    opencode_key: 'security-engineer',
    label: 'Security Engineer',
    role: 'Audit & Threat Model',
    icon: '🛡️',
    color: '#ef4444',
    variants: ['security-engineer', 'security', 'sec-engineer'],
  },
  {
    canonical_id: 'devops-engineer',
    opencode_key: 'devops-engineer',
  ...
  },
  {
    ...
    opencode_key: 'data-engineer',
    label: 'Data Engineer',
    role: 'Analytics & ETL',
    icon: '📊',
    color: '#0891b2',
    variants: ['data-engineer', 'data', 'data-analyst'],
  },
  {
    canonical_id: 'qa-engineer',
    opencode_key: 'qa-engineer',
    label: 'QA Engineer',
    role: 'Testing & Quality Gate',
    icon: '🧪',
    color: '#22c55e',
    variants: ['qa-engineer', 'qa', 'tester'],
  },
  {
    canonical_id: 'performance-engineer',
    opencode_key: 'performance-engineer',
    label: 'Performance Engineer',
    role: 'Profile & Optimize',
    icon: '📈',
    color: '#d946ef',
    variants: ['performance-engineer', 'performance', 'perf-engineer'],
  },
  {
    canonical_id: 'tech-writer',
    opencode_key: 'tech-writer',
    label: 'Tech Writer',
    role: 'Docs & Guides',
    icon: '📚',
    color: '#71717a',
